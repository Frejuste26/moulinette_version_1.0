...
const SageInventoryApp = () => {
    ...
    // Memoization des étapes du processus (données statiques)
    ...
    // URL de base de l'API - memoized pour éviter les re-créations
    const API_BASE_URL = useMemo(() => 'http://localhost:5000/api', []);

    // Fonction helper pour créer un fichier mock - memoized
    ...
    // Gestion de la sélection de session - memoized pour éviter les re-renders
    ...
    }, [createMockFile, showSuccess, showError, showInfo]);
